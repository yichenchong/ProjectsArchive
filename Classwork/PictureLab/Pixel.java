...
public class Pixel
{
  ...
  public void negateGreen() {
    ...
    public void fixUnderwater() {
        getRed();
        if(getRed()<25&&getGreen()>150&&getBlue()>150) setBlue(255);
    }
   /**
  ...
  public double brightnessDistance(Color testColor)
  {
      double averageThis = (this.getRed()+this.getGreen()+this.getBlue())/3;
      double averageTest = (testColor.getRed()+testColor.getGreen()+testColor.getBlue())/3;
      double distance = Math.abs(averageTest - averageThis);
      return distance;
    }
  /**
